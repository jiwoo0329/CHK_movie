    ...
    <div className="w_s-n">
        <h2><i class="fa-solid fa-circle"></i> gift - shop </h2>
          <div className="w_movie-shop">
            ...
            <img src="images/doctor.jpg" alt="닥터스트레인지"></img>
          </div>
        <br></br>
        <div className="w_merchlist">
          <Slider {...settings}>
            ...
            <div className="w_merchlist_box ">
              <img src="images/doctor/marvel_airpot.jpg"></img>
              <p>마블 에어팟 케이스</p>
              <h4>32,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/doctor/marvel_cup.jpg"></img>
              <p>마블 컵</p>
              <h4>18,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/doctor/marvel_figure.jpg"></img>
              <p>마블 피규어 set</p>
              <h4>48,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/doctor/marvel_tumbler.jpg"></img>
            ...
            <div className="w_merchlist_box">
              <img src="images/doctor/marvel_watch.jpg"></img>
              <p>마블 탁장시계</p>
              <h4>23,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/doctor/marvel_clothes.jpg"></img>
              <p>닥터스트레인지 맨투맨</p>
              <h4>47,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/doctor/marvel_cushion.jpg"></img>
              <p>닥터스트레인지 쿠션</p>
              <h4>31,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/doctor/marvel_hiddenbox.jpg"></img>
        ...
        <br></br><br></br><br></br>
          ...
          <div className="w_movie-shop">
            ...
            <img src="images/harry.png" alt="해리포터"></img>
          </div>
          <br></br>
        <div className="w_merchlist">
          <Slider {...settings}>
            <div className="w_merchlist_box">
              <img src="images/harry/harry_note.jpg"></img>
              <p>해리포터 노트</p>
              <h4>12,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/harry/harry_magmatic.jpg"></img>
              <p>해리포터 마그마틱</p>
              <h4>3,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/harry/harry_poster.jpg"></img>
              <p>해리포터 포스터</p>
              <h4>30,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/harry/harry_clothes.jpg"></img>
              <p>해리포터 맨투맨</p>
              <h4>56,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/harry/harry_pajamas.jpg"></img>
          ...
          <div className="w_movie-shop">
            ...
            <img src="images/forzen.jpg" alt="겨울왕국"></img>
          </div>
          <br></br>
        <div className="w_merchlist">
          <Slider {...settings}>
            <div className="w_merchlist_box">
              <img src="images/forzen/forzen_postcard.jpg"></img>
              <p>겨울왕국 5종 엽서 set</p>
              <h4>15,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/forzen/forzen_pen.jpg"></img>
              <p>겨울왕국 볼펜</p>
              <h4>5,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/forzen/forzen_cup.jpg"></img>
              <p>겨울왕국 텀블러</p>
              <h4>21,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/forzen/forzen_defuser.jpg"></img>
              <p>겨울왕국 디퓨저</p>
              <h4>34,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/forzen/forzen_lego.jpg"></img>
          ...
          <div className="w_movie-shop">
            ...
            <img src="images/toystory.png" alt="토이 스토리 4"></img>
          </div>
          <br></br>
        <div className="w_merchlist">
          <Slider {...settings}>
            <div className="w_merchlist_box">
              <img src="images/toy/toy_puzzle.jpg"></img>
            ...
            <div className="w_merchlist_box">
              <img src="images/toy/toy_body.jpg"></img>
            ...
            <div className="w_merchlist_box">
              <img src="images/toy/toy_woody.jpg"></img>
            ...
            <div className="w_merchlist_box">
              <img src="images/toy/toy_book.jpg"></img>
              <p>토이스토리 책</p>
              <h4>12,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/toy/toy_mini.jpg"></img>
              <p>토이스토리 스티커 북</p>
              <h4>8,000 원</h4>
          ...
          <div className="w_movie-shop">
            ...
            <img src="images/simson.jpg" alt="심슨"></img>
          </div>
          <br></br>
        <div className="w_merchlist">
          <Slider {...settings}>
            <div className="w_merchlist_box">
              <img src="images/simson/simson_badge.jpg"></img>
              <p>심슨 벳지</p>
              <h4>2,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/simson/simson_doll.jpg"></img>
              <p>심슨 인형</p>
              <h4>33,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/simson/simson_cushion.jpg"></img>
            ...
            <div className="w_merchlist_box">
              <img src="images/simson/simson_beachbag.jpg"></img>
              <p>심슨 비치가방</p>
              <h4>31,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/simson/simson_towel.jpg"></img>
              <p>심슨 비치타올</p>
              <h4>21,000 원</h4>
        ...
        <br></br><br></br><br></br>
          <div className="w_movie-shop">
            ...
            <img src="images/jjang-gu.jpg" alt="짱구"></img>
          </div>
          <br></br>
        <div className="w_merchlist">
          <Slider {...settings}>
            <div className="w_merchlist_box">
              <img src="images/jjanggu/jjanggu_case.jpg"></img>
              <p>짱구 핸드폰 케이스</p>
              <h4>22,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/jjanggu/jjanggu_keyring.jpg"></img>
            ...
            <div className="w_merchlist_box">
              <img src="images/jjanggu/jjanggu_file.jpg"></img>
              <p>짱구 파일</p>
              <h4>3,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/jjanggu/jjanggu_cup.jpg"></img>
              <p>짱구 컵</p>
              <h4>6,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/jjanggu/jjanggu_plate.jpg"></img>
              <p>짱구 냄비</p>
              <h4>27,000 원</h4>
            ...
            <div className="w_merchlist_box">
              <img src="images/jjanggu/jjanggu_blanket.jpg"></img>
